// title
document.getElementById("detail-title").innerText = localStorage.getItem("title");
// like count
...
document.getElementById("background-img").style.background = `url(${localStorage.getItem("backPoster")})`;
